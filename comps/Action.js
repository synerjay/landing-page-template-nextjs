...
const Action = () => {
  return (
    <div className='Testimonials py-2 flex px-5 flex-col justify-center items-center mx-auto sm:py-12'>
      <div className='h-auto py-7 md:py-10 px-7 md:px-10 w-full md:w-2/3 bg-indigo-500 flex flex-col justify-center items-center text-center space-y-7 md:mx-auto rounded-3xl shadow-xl hover:rotate-1 transition-transform'>
