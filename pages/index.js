...
export default function Home() {
  ...
  return (
    <Layout pageTitle='Product Landing Page'>
      ...
      <div class='GlassDiv flex absolute  z-50 flex-col lg:flex-row bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-xl overflow-hidden w-full max-w-5xl shadow-lg m-4 lg:m-6'>
        <div class='flex-1 p-4 lg:p-6'>
          ...
          <div class='grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-2'>
            <div class='rounded-2xl bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 p-4 flex flex-col relative undefined'>
